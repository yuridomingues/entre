...
export const experiments: Experiment[] = [
  ...
  { slug:"teseu", number:"15", eyebrow:"identidade", title:"Quando deixa de ser o mesmo?", description:"Substitua um barco peça por peça e marque onde, para você, a identidade muda.", question:"Quanto de uma coisa pode mudar antes de virar outra?", duration:"4 min", action:"troca de peças", tone:"sand", group:"experiment" },
  { slug:"perguntas", number:"16", eyebrow:"informação", title:"Qual pergunta vale mais?", description:"Descubra uma criatura escondida escolhendo perguntas que eliminam possibilidades.", question:"Uma pergunta pode valer mais do que outra?", duration:"3 min", action:"perguntas", tone:"mint", group:"experiment" },
  { slug:"regra", number:"17", eyebrow:"hipóteses", title:"Qual é a regra?", description:"Teste sequências para descobrir uma regra que começa com 2, 4, 6.", question:"Você tenta confirmar ou tenta quebrar sua hipótese?", duration:"4 min", action:"testes", tone:"ice", group:"experiment" },
  { slug:"minuto", number:"18", eyebrow:"tempo percebido", title:"Quanto dura um intervalo?", description:"Tente sentir dez, vinte ou trinta segundos sem olhar para um relógio.", question:"Seu tempo passa na mesma velocidade do relógio?", duration:"1 min", action:"cronômetro invisível", tone:"clay", group:"experiment" },
  { slug:"stroop", number:"19", eyebrow:"atenção + leitura", title:"Leia menos. Veja mais.", description:"Responda à cor da tinta enquanto a palavra tenta responder por você.", question:"É possível ignorar algo que seu cérebro lê sozinho?", duration:"2 min", action:"cores", tone:"violet", group:"experiment" },
  { slug:"mapa", number:"20", eyebrow:"mapas + distorção", title:"Um mapa pode contar a verdade inteira?", description:"Leve a mesma área do equador aos polos numa projeção de Mercator.", question:"O que precisa deformar quando uma esfera vira uma folha?", duration:"3 min", action:"latitude", tone:"ice", group:"experiment" },
  { slug:"profundidade", number:"21", eyebrow:"Terra + escala", title:"Abaixo dos seus pés", description:"Explore da superfície ao centro da Terra tocando o corte, a profundidade e os marcos.", question:"Quão fina é a parte do planeta que conseguimos tocar?", duration:"5 min", action:"viagem ao centro", tone:"moss", group:"experiment" }
];
