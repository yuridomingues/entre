...
export const experiments: Experiment[] = [
  ...
  { slug:"escala", number:"06", eyebrow:"escala", title:"Do grão ao planeta", description:"Aumente a régua e veja objetos familiares desaparecerem dentro de outros.", question:"Quando uma coisa deixa de parecer grande?", duration:"3 min", action:"zoom", tone:"lime" },
